...
public class BookRepositoryTest extends AbstractIntegrationTest {
	...
	public void findBookByTitle() {
		...
		assertThat(books.get(0).getAutor()).isEqualTo("Angel Gonzales");
	}

	@Test
	@UsingDataSet(locations = { "/books.json" }, loadStrategy = LoadStrategyEnum.CLEAN_INSERT)
	public void findBookByAutor() {
		List<Book> books = bookRepository.findByAutor("Martín Alaimo");
		assertThat(books).isNotNull();
		assertThat(books.size()).isEqualTo(1);
		assertThat(books.get(0)).isNotNull();
	...
	public void findBookByEdition() {
		...
		assertThat(books.get(0)).isNotNull();
		assertThat(books.get(0).getAutor()).isEqualTo("Isabel Allende");
	}
	...
	public void updateCategories() {
		...
		book.setAutor("Ángel Gonzáles");
		bookRepository.save(book);

		List<Book> booksAfterUpdate = bookRepository
				.findByAutor("Ángel Gonzáles");
