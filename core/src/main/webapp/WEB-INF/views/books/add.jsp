	...
	<div class="row-fluid">
		<div class="span8">
			...
			<form:form id="bookForm" method="post" modelAttribute="book"
				...
				<form:errors path="isbn" cssClass="alert alert-error" element="div" />

				<!-- title -->
				<form:label path="title" cssClass="string required control-label">
				...
				<!-- autor -->
				<form:label path="autor" cssClass="string required control-label">
					<abbr title="required">*</abbr> Autor</form:label>
				<form:input cssClass="input-block-level" path="autor" />
				<form:errors path="autor" cssClass="alert alert-error" element="div" />

				<!-- edition -->
				<form:label path="edition" cssClass="string required control-label">
				...
				<!-- review -->
				<form:label path="review" cssClass="string required control-label">
